package com.example.luana.proprietario_realm.activity;
        ...
        import com.example.luana.proprietario_realm.adapter.ClickRecyclerViewListener;
        import com.example.luana.proprietario_realm.adapter.ProprietarioAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ProprietarioActivity.this,Detalhe.class);
